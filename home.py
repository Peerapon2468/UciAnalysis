...
st.page_link("pages/KNNClassify.py", label="การนำเสนอการจำเเนกข้อมูลถั่วเเห้ง", icon="2️⃣", disabled=False)
st.page_link("pages/DecisionTreeClassify.py", label="การนำเสนอการจำเเนก", icon="2️⃣", disabled=False)
st.page_link("pages/RegressionPrediction.py", label="การจำเเนกข้อมูลด้วยเทคนิกRegression", icon="2️⃣", disabled=False)
st.page_link("pages/NaivebayeClassify.py", label="การจำเเนกข้อมูลด้วยเทคนิกNaivebaye", icon="2️⃣", disabled=False)
