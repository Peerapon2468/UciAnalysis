...
st.page_link("pages/Class01.py", label="การนำเสนอการจำเเนกข้อมูลถั่วเเห้ง", icon="2️⃣", disabled=False)
st.page_link("pages/4.py", label="การนำเสนอการจำเเนกข้อมูลถั่วเเห้ง", icon="2️⃣", disabled=False)
